...
// {
// using ObstacleDstarPtr = std::unique_ptr<obstacle_dstar::ObstacleDstar>;
...
// class OBSTACLE_DSTAR_PUBLIC ObstacleDstarNode : public rclcpp::Node
// {
// public:
//   explicit ObstacleDstarNode(const rclcpp::NodeOptions & options);

// private:
//   // ObstacleDstarPtr obstacle_dstar_{nullptr};
//   // ros
...
//   void getTrajectory(const Trajectory::ConstSharedPtr trajectory);
//   void reset();
